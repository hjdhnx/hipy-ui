<template>
  <div id="app" class="container">
    ...
    <div v-show="activeTab === 'formatConversion'" class="text-center mt-3">
      ...
      <el-upload class="upload-demo" action="false" drag multiple :before-upload="() => false"
    ...
    <footer>
      <el-row class="text-center mt-3 button-group">
        <el-button type="primary" @click="openServer">访问hipy后端项目主页</el-button>
        <el-button type="success" @click="openUi">访问hipy前端项目主页</el-button>
      </el-row>
    </footer>
  </div>
</template>
...
import jsonData from './logo.json';
...
export default {
  ...
  methods: {
    ...
    openServer() {
      window.open('https://github.com/hjdhnx/hipy-server', '_blank')
    },
    openUi() {
      window.open('https://github.com/hjdhnx/hipy-ui', '_blank')
    },
    handleTabClick(tab) {
